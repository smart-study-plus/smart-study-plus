...
const StudyGuidePage: React.FC = () => {
  ...
  const practiceTests: TestMap = (testsData?.practice_tests || []).reduce(
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {loading ? (
          ...
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            className="text-center p-6 bg-red-50 rounded-lg border border-red-200 max-w-2xl mx-auto"
          >
            <p className="text-lg font-semibold text-red-600">
              Error loading the study guide.
            </p>
            <Button
          ...
          >
            <motion.div
              variants={item}
              className="md:col-span-3 bg-white rounded-lg shadow-md p-6 border"
            >
