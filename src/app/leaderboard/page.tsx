...
const mockData: Record<string, UserStudyStats[]> = {
  studyHours: [
    { user_id: '1', name: 'Peyton', total_hours: 120.5 },
    { user_id: '2', name: 'Alex', total_hours: 110.0 },
    { user_id: '3', name: 'Jackson', total_hours: 95.3 },
    { user_id: '4', name: 'Yousif', total_hours: 80.1 },
    { user_id: '5', name: 'Professor Han', total_hours: 70.0 },
  ],
  testScores: [
    { user_id: '5', name: 'Professor Han', average_score: 95.0 },
    { user_id: '1', name: 'Peyton', average_score: 92.5 },
    { user_id: '2', name: 'Alex', average_score: 88.3 },
    { user_id: '3', name: 'Jackson', average_score: 85.0 },
    { user_id: '4', name: 'Yousif', average_score: 80.4 },
  ],
  guidesCompleted: [
    { user_id: '1', name: 'Peyton', guides_completed: 15 },
    { user_id: '2', name: 'Alex', guides_completed: 13 },
    { user_id: '3', name: 'Jackson', guides_completed: 11 },
    { user_id: '4', name: 'Yousif', guides_completed: 9 },
    { user_id: '5', name: 'Professor Han', guides_completed: 6 },
  ],
};
...
const LeaderboardPage = () => {
  ...
  const leaderboardData = mockData[mode];
        ...
        <table className="min-w-full text-sm text-left">
          ...
          <tbody>
            {leaderboardData.map((user, index) => (
              <tr
                key={user.user_id}
                className={user.name === 'Peyton' ? 'bg-yellow-100 font-semibold' : 'hover:bg-gray-50'}
              >
